...
#head(avar)
avar_cognate_test <- avar[avar$District %in% c("Akhvakh", "Botlikh", "Tsunta") | avar$Speaker %in% c("D_Avar"),]
...
Area <- factor(all_turkic_counts$District, levels  = c("Rutul","Tsunta","Botlikh","Akhvakh"))
p1 <- ggplot(data = all_turkic_counts, aes(x = District, y = Loans)) + 
    ...
    labs(title = "Turkic Influence", x = "District", y = "Number of Turkic Loanwords")+
    theme_bw()#+
...
Area <- factor(avar_counts$District, levels  = c("Rutul","Tsunta","Botlikh","Akhvakh"))
p2 <- ggplot(data = avar_counts, aes(x = District, y = Loans)) + 
    geom_jitter(aes(color = Village), position = position_jitter(width = 0.1, height = 0.1)) +
    # levels = c("Dyubek","Tatil","Khapil","Yagdyg","Khiv","Laka","Khoredzh","Kiche","Rutul","Kina","Ikhrek", "Helmets", "Mikik")
    stat_summary(fun.y = "median", geom = "point", pch = 3, group = 1, size = 5)+
    labs(title = "Avar Influence", x = "District", y = "Number of Avar Loanwords")+
    theme_bw()#+
   #theme(legend.position = "none")
...
Area <- factor(georgian_counts$District, levels  = c("Rutul","Tsunta","Botlikh","Akhvakh"))
p3 <- ggplot(data = georgian_counts, aes(x = District, y = Loans)) + 
    geom_jitter(aes(color = Village), position = position_jitter(width = 0.1, height = 0.1)) +
    # levels = c("Dyubek","Tatil","Khapil","Yagdyg","Khiv","Laka","Khoredzh","Kiche","Rutul","Kina","Ikhrek", "Helmets", "Mikik")
    stat_summary(fun.y = "median", geom = "point", pch = 3, group = 1, size = 5)+
    labs(title = "Georgian Influence", x = "District", y = "Number of Georgian Loanwords")+
    theme_bw()#+
   #theme(legend.position = "none")
...
Area <- factor(chechen_counts$District, levels  = c("Rutul","Tsunta","Botlikh","Akhvakh"))
p4 <- ggplot(data = chechen_counts, aes(x = Area, y = Loans)) + 
    geom_jitter(aes(color = Village), position = position_jitter(width = 0.1, height = 0.1)) +
    # levels = c("Dyubek","Tatil","Khapil","Yagdyg","Khiv","Laka","Khoredzh","Kiche","Rutul","Kina","Ikhrek", "Helmets", "Mikik")
    stat_summary(fun.y = "median", geom = "point", pch = 3, group = 1, size = 5)+
    labs(title = "Chechen Influence", x = "District", y = "Number of Chechen Loanwords")+
    theme_bw()#+
   #theme(legend.position = "none")
...
p5 <- ggplot(data = loan_counts, aes(x = Area, y = Loans)) + 
    geom_jitter(aes(color = Village), position = position_jitter(width = 0.1, height = 0.1)) +
    stat_summary(fun.y = "median", geom = "point", pch = 3, group = 1, size = 5)+
    labs(title = "Foreign Influence", x = "District", y = "Number of Loanwords")+
    theme_bw()+
    facet_wrap(. ~ factor(Source, levels = c("Turkic", "Avar", "Georgian", "Chechen")), nrow = 1)+
