...
words <- read_tsv("words_20022019.csv")
...
## The data in the dummy format:
```{r, echo=FALSE, message=FALSE, warning=FALSE}
dummy_dataset <- words <- read_tsv("words20022019_dummy.csv")
datatable(dummy_dataset, class = 'cell-border stripe', filter = 'top', options = list(pageLength = 100))
```
---
